          ...
          <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 configurationColumnLeft">
            <table class="table table-hover">
              ...
              <tbody>
                  ...
                  /* BOF Zen4All Multi Language Zone Names 1 of 1 */
                  $zones_query_raw = "SELECT a.association_id, a.zone_country_id, cn.countries_name, a.zone_id, a.geo_zone_id, a.last_modified, a.date_added, zn.zone_name
                                      ...
                                      LEFT JOIN " . TABLE_ZONES_NAME . " zn ON zn.zone_id = a.zone_id
                  ...
                  /* EOF Zen4All Multi Language Zone Names 1 of 1 */
// Split Page
