                  ...
                  if ($error == true) {
                    if ($entry_state_error == true) {
                      if ($entry_state_has_zones == true) {
                        ...
                        $zones_values = $db->Execute("SELECT zn.zone_name
                                                      FROM " . TABLE_ZONES_ . " z
                                                      LEFT JOIN " . TABLE_ZONES_NAME . " zn ON zn_zone_id = z.zone_id
                                                        AND zn.language_id = " . (int)$_SESSION['languages_id'] . "
                                                      WHERE z.zone_country_id = " . (int)zen_db_input($cInfo->entry_country_id) . "
